...
{
public:
	Microsoft::WRL::ComPtr<ID3D11DepthStencilView> m_pDepthStencilView;	//뎁스스텐실뷰
	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> m_pSRV;			//리소스뷰
	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> m_pDsvSRV;			//뎁스스텐실 리소스뷰
public:
